...
class SiteFiltersAndActionsV2 extends StatefulWidget {
  ...
  @override
  State<SiteFiltersAndActionsV2> createState() =>
      _SiteFiltersAndActionsV2State();
}

class _SiteFiltersAndActionsV2State extends State<SiteFiltersAndActionsV2> {
  ...
  @override
  void didUpdateWidget(SiteFiltersAndActionsV2 oldWidget) {
  ...
  Widget build(BuildContext context) {
    return UniversalFiltersAndActions<SiteViewMode>(
      // Basic properties
      searchHint: 'Search sites...',
      onSearchChanged: widget.onSearchChanged,
      onAddItem: widget.onAddSite,
      onRefresh: widget.onRefresh,
      addButtonText: 'Add Site',
      addButtonIcon: Icons.add,

      // View modes
      availableViewModes: SiteViewMode.values,
  ...
  void _handleAdvancedFiltersChanged(Map<String, dynamic> filters) {
    ...
    print('Site advanced filters applied: $filters');
